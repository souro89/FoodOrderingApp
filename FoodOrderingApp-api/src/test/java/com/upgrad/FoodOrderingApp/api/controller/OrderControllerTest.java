...
public class OrderControllerTest {
    ...
    public void shouldGetPlacedOrderDetails() throws Exception {
        ...
        assertEquals(customerOrderResponse.getOrders().get(0).getId().toString(), orderEntity.getUuid());
        assertEquals(customerOrderResponse.getOrders().get(0).getCustomer().getId().toString(), orderEntity.getCustomerEntity().getUuid());
        assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getId().toString(), orderEntity.getAddressEntity().getUuid());
        assertEquals(customerOrderResponse.getOrders().get(0).getAddress().getState().getId().toString(), orderEntity.getAddressEntity().getStateEntity().getUuid());
    ...
    public void shouldGetCouponByName() throws Exception {
        ...
        when(mockOrderService.getCouponByName("myCoupon")).thenReturn(couponEntity);
    ...
    public void shouldNotGetCouponByNameIfCouponNameFieldIsEmpty() throws Exception {
        ...
        when(mockOrderService.getCouponByName(anyString()))
    ...
    public void shouldNotGetCouponByNameIfItDoesNotExists() throws Exception {
        ...
        when(mockOrderService.getCouponByName("myCoupon"))
