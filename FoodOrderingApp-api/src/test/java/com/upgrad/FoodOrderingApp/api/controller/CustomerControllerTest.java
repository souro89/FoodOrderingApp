...
public class CustomerControllerTest {
    ...
    public void shouldLoginForValidRequest() throws Exception {
        ...
        createdCustomerAuthEntity.setCustomerEntity(customerEntity);

        when(mockCustomerService.loginService("9090909090", "CorrectPassword"))
        ...
        verify(mockCustomerService, times(1)).loginService("9090909090", "CorrectPassword");
    }
    ...
    public void shouldNotLoginForInvalidAuthorizationFormat() throws Exception {
        ...
        verify(mockCustomerService, times(0)).loginService(anyString(), anyString());
    }
    ...
    public void shouldNotLoginIfNoDataPresentForGivenMobileNo() throws Exception {
        when(mockCustomerService.loginService("123", "CorrectPassword"))
        ...
        verify(mockCustomerService, times(1)).loginService("123", "CorrectPassword");
    }
    ...
    public void shouldNotLoginForWrongPassword() throws Exception {
        when(mockCustomerService.loginService("9090909090", "IncorrectPassword"))
        ...
        verify(mockCustomerService, times(1)).loginService("9090909090", "IncorrectPassword");
    }
    ...
    public void shouldUpdateCustomerDetails() throws Exception {
        ...
        when(mockCustomerService.updateCustomerEntity(customerEntity)).thenReturn(updatedCustomerEntity);
        mockMvc
        ...
        verify(mockCustomerService, times(1)).updateCustomerEntity(customerEntity);
    }
    ...
    public void shouldNotUpdateCustomerDetailsIfFirstNameNotPresentInTheRequest() throws Exception {
        ...
        verify(mockCustomerService, times(0)).updateCustomerEntity(any());
    }
    ...
    public void shouldUpdateCustomerPassword() throws Exception {
        ...
        when(mockCustomerService.getCustomer("auth")).thenReturn(customerEntity);
        when(mockCustomerService.changePassword("oldPwd", "newPwd", customerEntity))
        ...
        mockMvc
                ...
                .andExpect(jsonPath("id").value(customerId));
        verify(mockCustomerService, times(1)).getCustomer("auth");
        verify(mockCustomerService, times(1)).changePassword("oldPwd", "newPwd", customerEntity);
    }
